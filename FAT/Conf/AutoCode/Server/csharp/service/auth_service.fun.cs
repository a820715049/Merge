...
// source: service/auth_service.proto
...
namespace fat.service {
	...
	/// </summary> 
	public partial class AuthorizeService_Authorize : ProtoServiceInterface{
		...
		/// 当前 Service 的请求根路径
		/// </summary> 
		public const string QueryPath = "/auth";

		/// <summary>
		/// HTTP 请求全路径，格式为 QueryPath /XXX, 其中XXX部分可以是自定义字符串或URIRequest
		/// </summary>
		public const string FullPathHTTP = "/auth/authorize";
		...
		/// </summary>
		public const string URIRequest = "/service.AuthorizeService/Authorize";

		/// <summary>
		/// 构造当前方法的请求对象
		/// </summary> 
		/// <returns> 当前方法的请求对象，类型: msg.AuthorizeReq </returns>
		public static msg.AuthorizeReq NewRequest() { return new msg.AuthorizeReq(); }

		/// <summary>
		/// 当前方法返回对象的URI，即: msg.AuthorizeRspOverride.Descriptor.FullName
		/// </summary> 
		public static readonly string URIResponse = "msg.AuthorizeRspOverride";

		/// <summary>
		/// 构造当前方法的返回对象
		/// </summary> 
		/// <returns> 当前方法的返回对象，类型: msg.AuthorizeRspOverride </returns>
		public static msg.AuthorizeRspOverride NewResponse() { return new msg.AuthorizeRspOverride(); }
		...
		public const string PathHTTP = "/auth/authorize";
		...
		/// </summary>
		public static void PostMessage(msg.AuthorizeReq request, Action<IMessage> callback = null,
		...
		/// </summary>
		public static void SendMessage(msg.AuthorizeReq request, Action<IMessage> handler = null,
