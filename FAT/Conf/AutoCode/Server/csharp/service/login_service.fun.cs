...
// source: service/login_service.proto
...
namespace fat.service {
	...
	/// </summary> 
	public partial class LoginService_Login : ProtoServiceInterface{
		...
		/// </summary>
		public const string FullPathHTTP = "/biz/service.LoginService/Login";
		...
		/// </summary>
		public const string URIRequest = "/service.LoginService/Login";

		/// <summary>
		/// 构造当前方法的请求对象
		/// </summary> 
		/// <returns> 当前方法的请求对象，类型: msg.LoginReq </returns>
		public static msg.LoginReq NewRequest() { return new msg.LoginReq(); }

		/// <summary>
		/// 当前方法返回对象的URI，即: msg.LoginResp.Descriptor.FullName
		/// </summary> 
		public static readonly string URIResponse = "msg.LoginResp";

		/// <summary>
		/// 构造当前方法的返回对象
		/// </summary> 
		/// <returns> 当前方法的返回对象，类型: msg.LoginResp </returns>
		public static msg.LoginResp NewResponse() { return new msg.LoginResp(); }
		...
		public const string PathHTTP = "/service.LoginService/Login";
		...
		/// </summary>
		public static void PostMessage(msg.LoginReq request, Action<IMessage> callback = null,
		...
		/// </summary>
		public static void SendMessage(msg.LoginReq request, Action<IMessage> handler = null,
