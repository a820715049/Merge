...
// source: service/mock_service.proto
...
namespace fat.service {
	...
	/// </summary> 
	public partial class MockService_Mock : ProtoServiceInterface{
		...
		/// 当前 Service 的请求根路径
		/// </summary> 
		public const string QueryPath = "/";

		/// <summary>
		/// HTTP 请求全路径，格式为 QueryPath /XXX, 其中XXX部分可以是自定义字符串或URIRequest
		/// </summary>
		public const string FullPathHTTP = "/service.MockService/Mock";
		...
		/// </summary>
		public const string URIRequest = "/service.MockService/Mock";

		/// <summary>
		/// 构造当前方法的请求对象
		/// </summary> 
		/// <returns> 当前方法的请求对象，类型: msg.MockMessageReq </returns>
		public static msg.MockMessageReq NewRequest() { return new msg.MockMessageReq(); }

		/// <summary>
		/// 当前方法返回对象的URI，即: msg.MockMessageRsp.Descriptor.FullName
		/// </summary> 
		public static readonly string URIResponse = "msg.MockMessageRsp";

		/// <summary>
		/// 构造当前方法的返回对象
		/// </summary> 
		/// <returns> 当前方法的返回对象，类型: msg.MockMessageRsp </returns>
		public static msg.MockMessageRsp NewResponse() { return new msg.MockMessageRsp(); }
		...
		public const string PathHTTP = "/service.MockService/Mock";
		...
		/// </summary>
		public static void PostMessage(msg.MockMessageReq request, Action<IMessage> callback = null,
		...
		/// </summary>
		public static void SendMessage(msg.MockMessageReq request, Action<IMessage> handler = null,
