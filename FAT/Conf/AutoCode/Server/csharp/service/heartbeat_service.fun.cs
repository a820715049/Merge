...
// source: service/heartbeat_service.proto
...
namespace fat.service {
	...
	/// </summary> 
	public partial class HeartbeatService_Hi : ProtoServiceInterface{
		...
		/// </summary>
		public const string FullPathHTTP = "/biz/service.HeartbeatService/Hi";
		...
		/// </summary>
		public const string URIRequest = "/service.HeartbeatService/Hi";

		/// <summary>
		/// 构造当前方法的请求对象
		/// </summary> 
		/// <returns> 当前方法的请求对象，类型: msg.HeartbeatReq </returns>
		public static msg.HeartbeatReq NewRequest() { return new msg.HeartbeatReq(); }

		/// <summary>
		/// 当前方法返回对象的URI，即: msg.HeartbeatResp.Descriptor.FullName
		/// </summary> 
		public static readonly string URIResponse = "msg.HeartbeatResp";

		/// <summary>
		/// 构造当前方法的返回对象
		/// </summary> 
		/// <returns> 当前方法的返回对象，类型: msg.HeartbeatResp </returns>
		public static msg.HeartbeatResp NewResponse() { return new msg.HeartbeatResp(); }
		...
		public const string PathHTTP = "/service.HeartbeatService/Hi";
		...
		/// </summary>
		public static void PostMessage(msg.HeartbeatReq request, Action<IMessage> callback = null,
		...
		/// </summary>
		public static void SendMessage(msg.HeartbeatReq request, Action<IMessage> handler = null,
