...
using EventTreasureGroupDetailConf = fat.rawdata.EventTreasureGroupDetailConf;
using rawEventTreasureGroupDetail = fat.rawdata.EventTreasureGroupDetail;
using rawEventTreasureGroupDetailMapABValue = fat.rawdata.EventTreasureGroupDetailMapABValue;
using PBC = global::Google.Protobuf.Collections;
using ConfManager = fat.conf.conf_loader.ConfManager;

namespace fat.conf
{
    public partial class EventTreasureGroupDetailVisitor
    {
		...
		public const string FileName = "EventTreasureGroupDetailConf";
		// 默认ABTag，可以通过ConfManager.SetABDefault设定全局默认的AB Tag，也可以通过EventTreasureGroupDetailVisitor.SetABDefault单独设定EventTreasureGroupDetail的默认tag
		private static string DefaultABTag = ConfManager.TagFoundation;
		// 默认AB fallback策略，可以通过ConfManager.SetABFallback设定全局默认的AB fallback策略，也可以通过EventTreasureGroupDetailVisitor.SetABFallback单独设定EventTreasureGroupDetail的fallback策略
		private static Dictionary<string, List<string>>? abFallback = null;	
		private static Lazy<PBC::MapField<int, rawEventTreasureGroupDetail>> emptyAllReadonly = new Lazy<PBC::MapField<int, rawEventTreasureGroupDetail>>(()=> new PBC::MapField<int, rawEventTreasureGroupDetail>());
		// 加载标记
		...
		// All 返回全量数据Map
		public static (PBC::MapField<int, rawEventTreasureGroupDetail>,string) _allWithTag(string abTag="")
		{
			if (!tryLazyLoad())
            {
				ConfManager.ExceptionOnLazyLoadFailed(FileName,"lazy load failed");
            }
			var v = ConfManager.GetCurrent().EventTreasureGroupDetailMap;
			var abMap = v.EventTreasureGroupDetailMapAB;
			var abUsing = abTagTryFallback(abTag==""?DefaultABTag:abTag,abMap);
			if(abUsing == ConfManager.TagFoundation){
				return (v.EventTreasureGroupDetailMap,abUsing);
			}else if(abUsing == ""){
				return (emptyAllReadonly.Value,abUsing);
			}
			return (abMap[abUsing].EventTreasureGroupDetailMap,abUsing);
		}
		// All 返回全量数据Map
		public static PBC::MapField<int, rawEventTreasureGroupDetail> All(string abTag="")
		{
		...
		public static List<string> ABList() {
			...
			var v = ConfManager.GetCurrent().EventTreasureGroupDetailMap;
			if (v.EventTreasureGroupDetailMapAB == null) {
				return new List<string>();
			}
			return new List<string>(v.EventTreasureGroupDetailMapAB.Keys);
		}
		// 基础标签或abMap含数据则返回; 否则进入fallback策略，如未设定则返回空.
		public static string abTagTryFallback(string ab, PBC::MapField<string, rawEventTreasureGroupDetailMapABValue> abMap)
		{
		...
		// 检测ab patch
		public static void Patch(EventTreasureGroupDetailConf cc) {
			foreach(KeyValuePair <string, rawEventTreasureGroupDetailMapABValue> tagEntry in cc.EventTreasureGroupDetailMapABPatch) 
			{
				var tag = tagEntry.Key;
				if (!cc.EventTreasureGroupDetailMapAB.TryGetValue(tag, out var ps))
				{
					ps = new rawEventTreasureGroupDetailMapABValue();
					cc.EventTreasureGroupDetailMapAB[tag] = ps;
				}
                var tagTmp = ps.EventTreasureGroupDetailMap;
				// 基础数据
				foreach(KeyValuePair <int, rawEventTreasureGroupDetail> entry in cc.EventTreasureGroupDetailMap) 
				{
					tagTmp[entry.Key] = entry.Value;
				}
				// patch数据
				foreach(KeyValuePair <int, rawEventTreasureGroupDetail> entry in tagEntry.Value.EventTreasureGroupDetailMap) 
				{
					tagTmp[entry.Key] = entry.Value;
				}
			}
		}
		private static void __UpdateReferenceWithTableData(Dictionary<string, object> ctx,ConfManager current,PBC::MapField<int,fat.rawdata.EventTreasureGroupDetail> tableData)
		{
		}
		...
		private static Dictionary<string, List<int>> genSortedKeys(EventTreasureGroupDetailConf cc) 
		{
			...
			if (!ret.TryGetValue(ConfManager.TagFoundation, out var listFoundation))
			{
				...
				listFoundation.AddRange(cc.EventTreasureGroupDetailMap.Keys);
				ret[ConfManager.TagFoundation] = listFoundation;
			}

			if (cc.EventTreasureGroupDetailMapAB != null)
			{
				foreach (var entry in cc.EventTreasureGroupDetailMapAB)
				{
					if (!ret.TryGetValue(entry.Key, out var list))
					{
						list = new List<int>();
						list.AddRange(entry.Value.EventTreasureGroupDetailMap.Keys);
						ret[entry.Key] = list;
					}
				}
			}
		...
		public static void  LoadFromStream(Google.Protobuf.CodedInputStream cis) {
			...
			updating.EventTreasureGroupDetailMap.MergeFrom(cis);
			Patch(updating.EventTreasureGroupDetailMap);
			updating.EventTreasureGroupDetailSortedKeys = genSortedKeys(updating.EventTreasureGroupDetailMap);
		...
		public static void Load(Dictionary<string, object> ctx, string key, Google.Protobuf.CodedInputStream cis)
        {
           ...
           if (updating == null) {
            ...
            var tmp = new EventTreasureGroupDetailConf();
            tmp.MergeFrom(cis);
			updating.EventTreasureGroupDetailMap = tmp;
		...
		{
			var v = ConfManager.GetCurrent().EventTreasureGroupDetailSortedKeys;
			var abUsing = (tag=="")?DefaultABTag:tag;
			return v[abUsing];
		}
		public static void Range(Action<int, rawEventTreasureGroupDetail> filter,string tag=""){
		...
		public static rawEventTreasureGroupDetail MustGet(int key,string tag="") {
		...
		public static rawEventTreasureGroupDetail? Get(int key,string tag="") {
			var (pl,tagActual) = _allWithTag(tag);
			if (pl.TryGetValue(key, out var value))
			{
				return value;
		...
		public static List<rawEventTreasureGroupDetail> GetByFilter(Func<rawEventTreasureGroupDetail, bool> filterFunc,string tag="") {
			List<rawEventTreasureGroupDetail> ret = new List<rawEventTreasureGroupDetail>();
			foreach(KeyValuePair <int, rawEventTreasureGroupDetail> entry in All(tag)) {
				if(filterFunc(entry.Value))
					ret.Add(entry.Value);
			}
			return ret;
		}
		static public rawEventTreasureGroupDetail? GetOneByFilter(Func<rawEventTreasureGroupDetail, bool> filterFunc,string tag="") {
			var (pl,tagActual) = _allWithTag(tag);
			foreach(KeyValuePair <int, rawEventTreasureGroupDetail> entry in pl) {
				if(filterFunc(entry.Value))
					return entry.Value;
			}
		...
		static public int MapKey(rawEventTreasureGroupDetail data) 
		{
			return data.Id;			
		}
    }
