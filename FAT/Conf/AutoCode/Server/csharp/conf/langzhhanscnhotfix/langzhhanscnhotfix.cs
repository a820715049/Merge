...
using LangZhHansCnHotfixConf = fat.rawdata.LangZhHansCnHotfixConf;
using rawLangZhHansCnHotfix = fat.rawdata.LangZhHansCnHotfix;
using rawLangZhHansCnHotfixSliceABValue = fat.rawdata.LangZhHansCnHotfixSliceABValue;
using PBC = global::Google.Protobuf.Collections;
using ConfManager = fat.conf.conf_loader.ConfManager;

namespace fat.conf
{
    public partial class LangZhHansCnHotfixVisitor
    {
		...
		public const string FileName = "LangZhHansCnHotfixConf";
		// 默认ABTag，可以通过ConfManager.SetABDefault设定全局默认的AB Tag，也可以通过LangZhHansCnHotfixVisitor.SetABDefault单独设定LangZhHansCnHotfix的默认tag
		private static string DefaultABTag = ConfManager.TagFoundation;
		// 默认AB fallback策略，可以通过ConfManager.SetABFallback设定全局默认的AB fallback策略，也可以通过LangZhHansCnHotfixVisitor.SetABFallback单独设定LangZhHansCnHotfix的fallback策略
		private static Dictionary<string, List<string>>? abFallback = null;
		private static Lazy<PBC::RepeatedField<rawLangZhHansCnHotfix>> emptyAllReadonly = new Lazy<PBC::RepeatedField<rawLangZhHansCnHotfix>>(()=>new PBC::RepeatedField<rawLangZhHansCnHotfix>());
		// 加载标记
		...
		// All 返回全量数据列表
		public static (PBC::RepeatedField<rawLangZhHansCnHotfix>,string) _allWithTag(string abTag="")
		{
			if (!tryLazyLoad())
            {
				ConfManager.ExceptionOnLazyLoadFailed(FileName,"lazy load failed");
            }
			var v = ConfManager.GetCurrent().LangZhHansCnHotfixSlice;
			var abMap = v.LangZhHansCnHotfixSliceAB;
			var abUsing = abTagTryFallback(abTag==""?DefaultABTag:abTag,abMap);
			if(abUsing == ConfManager.TagFoundation){
				return (v.LangZhHansCnHotfixSlice,abUsing);
			}else if(abUsing == ""){
				return (emptyAllReadonly.Value,abUsing);
			}
			return (abMap[abUsing].LangZhHansCnHotfixSlice,abUsing);
		}
		// All 返回全量数据列表
		public static PBC::RepeatedField<rawLangZhHansCnHotfix> All(string abTag="")
		{
		...
		public static List<string> ABList() {
			...
			var v = ConfManager.GetCurrent().LangZhHansCnHotfixSlice;
			if (v.LangZhHansCnHotfixSliceAB == null) {
				return new List<string>();
			}
			return new List<string>(v.LangZhHansCnHotfixSliceAB.Keys);
		}
		// 基础标签或abMap含数据则返回; 否则进入fallback策略，如未设定则返回空.
		public static string abTagTryFallback(string ab, PBC::MapField<string, rawLangZhHansCnHotfixSliceABValue> abMap)
		{
		...
		// 检测ab patch
		public static void Patch(LangZhHansCnHotfixConf cc) {
			foreach(KeyValuePair <string, rawLangZhHansCnHotfixSliceABValue> tagEntry in cc.LangZhHansCnHotfixSliceABPatch) 
			{
				var tag = tagEntry.Key;
				if (!cc.LangZhHansCnHotfixSliceAB.TryGetValue(tag, out var ps))
				{
					ps = new rawLangZhHansCnHotfixSliceABValue();
					cc.LangZhHansCnHotfixSliceAB[tag] = ps;
				}
                var tagTmp = ps.LangZhHansCnHotfixSlice;
				// 基础数据
				for(int i=0; i<cc.LangZhHansCnHotfixSlice.Count; ++i) 
				{
					tagTmp.Add(cc.LangZhHansCnHotfixSlice[i]);
				}
				// patch 数据
				var patchData = tagEntry.Value.LangZhHansCnHotfixSlice;
		...
		private static void __UpdateReferenceWithTableData(Dictionary<string, object> ctx,ConfManager current,PBC::RepeatedField<fat.rawdata.LangZhHansCnHotfix> tableData)
		{
		}
		...
		public static void  LoadFromStream(Google.Protobuf.CodedInputStream cis) {
			...
			updating.LangZhHansCnHotfixSlice.MergeFrom(cis);
			Patch(updating.LangZhHansCnHotfixSlice);
		...
		public static void Load(Dictionary<string, object> ctx, string key, Google.Protobuf.CodedInputStream cis)
        {
           ...
           if (updating == null) {
            ...
            var tmp = new LangZhHansCnHotfixConf();
            tmp.MergeFrom(cis);
			updating.LangZhHansCnHotfixSlice = tmp;
		...
		public static void Range(Action<int, rawLangZhHansCnHotfix> filter,string tag="") {
			var pl = All(tag);
		...
		public static rawLangZhHansCnHotfix MustGetByIndex(int index,string tag="") {
		...
		public static rawLangZhHansCnHotfix? GetByIndex(int index,string tag="") {
			var (pl,tagActual) = _allWithTag(tag);
			if (index < 0 || index >= pl.Count)
			{
		...
		static public List<rawLangZhHansCnHotfix> GetByFilter(Func<rawLangZhHansCnHotfix,bool> filterFunc,string tag="") {
			var pl = All(tag);
			var ret = new List<rawLangZhHansCnHotfix>();
		...
		static public rawLangZhHansCnHotfix? GetOneByFilter(Func<rawLangZhHansCnHotfix,bool> filterFunc,string tag="")  {
			var (pl,tagActual) = _allWithTag(tag);
			foreach (var val in pl)
			{
				if (filterFunc(val))
