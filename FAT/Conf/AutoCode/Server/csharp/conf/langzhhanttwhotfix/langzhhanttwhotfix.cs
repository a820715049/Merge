...
using LangZhHantTwHotfixConf = fat.rawdata.LangZhHantTwHotfixConf;
using rawLangZhHantTwHotfix = fat.rawdata.LangZhHantTwHotfix;
using rawLangZhHantTwHotfixSliceABValue = fat.rawdata.LangZhHantTwHotfixSliceABValue;
using PBC = global::Google.Protobuf.Collections;
using ConfManager = fat.conf.conf_loader.ConfManager;

namespace fat.conf
{
    public partial class LangZhHantTwHotfixVisitor
    {
		...
		public const string FileName = "LangZhHantTwHotfixConf";
		// 默认ABTag，可以通过ConfManager.SetABDefault设定全局默认的AB Tag，也可以通过LangZhHantTwHotfixVisitor.SetABDefault单独设定LangZhHantTwHotfix的默认tag
		private static string DefaultABTag = ConfManager.TagFoundation;
		// 默认AB fallback策略，可以通过ConfManager.SetABFallback设定全局默认的AB fallback策略，也可以通过LangZhHantTwHotfixVisitor.SetABFallback单独设定LangZhHantTwHotfix的fallback策略
		private static Dictionary<string, List<string>>? abFallback = null;
		private static Lazy<PBC::RepeatedField<rawLangZhHantTwHotfix>> emptyAllReadonly = new Lazy<PBC::RepeatedField<rawLangZhHantTwHotfix>>(()=>new PBC::RepeatedField<rawLangZhHantTwHotfix>());
		// 加载标记
		...
		// All 返回全量数据列表
		public static (PBC::RepeatedField<rawLangZhHantTwHotfix>,string) _allWithTag(string abTag="")
		{
			if (!tryLazyLoad())
            {
				ConfManager.ExceptionOnLazyLoadFailed(FileName,"lazy load failed");
            }
			var v = ConfManager.GetCurrent().LangZhHantTwHotfixSlice;
			var abMap = v.LangZhHantTwHotfixSliceAB;
			var abUsing = abTagTryFallback(abTag==""?DefaultABTag:abTag,abMap);
			if(abUsing == ConfManager.TagFoundation){
				return (v.LangZhHantTwHotfixSlice,abUsing);
			}else if(abUsing == ""){
				return (emptyAllReadonly.Value,abUsing);
			}
			return (abMap[abUsing].LangZhHantTwHotfixSlice,abUsing);
		}
		// All 返回全量数据列表
		public static PBC::RepeatedField<rawLangZhHantTwHotfix> All(string abTag="")
		{
		...
		public static List<string> ABList() {
			...
			var v = ConfManager.GetCurrent().LangZhHantTwHotfixSlice;
			if (v.LangZhHantTwHotfixSliceAB == null) {
				return new List<string>();
			}
			return new List<string>(v.LangZhHantTwHotfixSliceAB.Keys);
		}
		// 基础标签或abMap含数据则返回; 否则进入fallback策略，如未设定则返回空.
		public static string abTagTryFallback(string ab, PBC::MapField<string, rawLangZhHantTwHotfixSliceABValue> abMap)
		{
		...
		// 检测ab patch
		public static void Patch(LangZhHantTwHotfixConf cc) {
			foreach(KeyValuePair <string, rawLangZhHantTwHotfixSliceABValue> tagEntry in cc.LangZhHantTwHotfixSliceABPatch) 
			{
				var tag = tagEntry.Key;
				if (!cc.LangZhHantTwHotfixSliceAB.TryGetValue(tag, out var ps))
				{
					ps = new rawLangZhHantTwHotfixSliceABValue();
					cc.LangZhHantTwHotfixSliceAB[tag] = ps;
				}
                var tagTmp = ps.LangZhHantTwHotfixSlice;
				// 基础数据
				for(int i=0; i<cc.LangZhHantTwHotfixSlice.Count; ++i) 
				{
					tagTmp.Add(cc.LangZhHantTwHotfixSlice[i]);
				}
				// patch 数据
				var patchData = tagEntry.Value.LangZhHantTwHotfixSlice;
		...
		private static void __UpdateReferenceWithTableData(Dictionary<string, object> ctx,ConfManager current,PBC::RepeatedField<fat.rawdata.LangZhHantTwHotfix> tableData)
		{
		}
		...
		public static void  LoadFromStream(Google.Protobuf.CodedInputStream cis) {
			...
			updating.LangZhHantTwHotfixSlice.MergeFrom(cis);
			Patch(updating.LangZhHantTwHotfixSlice);
		...
		public static void Load(Dictionary<string, object> ctx, string key, Google.Protobuf.CodedInputStream cis)
        {
           ...
           if (updating == null) {
            ...
            var tmp = new LangZhHantTwHotfixConf();
            tmp.MergeFrom(cis);
			updating.LangZhHantTwHotfixSlice = tmp;
		...
		public static void Range(Action<int, rawLangZhHantTwHotfix> filter,string tag="") {
			var pl = All(tag);
		...
		public static rawLangZhHantTwHotfix MustGetByIndex(int index,string tag="") {
		...
		public static rawLangZhHantTwHotfix? GetByIndex(int index,string tag="") {
			var (pl,tagActual) = _allWithTag(tag);
			if (index < 0 || index >= pl.Count)
			{
		...
		static public List<rawLangZhHantTwHotfix> GetByFilter(Func<rawLangZhHantTwHotfix,bool> filterFunc,string tag="") {
			var pl = All(tag);
			var ret = new List<rawLangZhHantTwHotfix>();
		...
		static public rawLangZhHantTwHotfix? GetOneByFilter(Func<rawLangZhHantTwHotfix,bool> filterFunc,string tag="")  {
			var (pl,tagActual) = _allWithTag(tag);
			foreach (var val in pl)
			{
				if (filterFunc(val))
