...
namespace UnityEngine.UI
{
    ...
    public class UISimpleToggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        /// <summary>
        ...
        [SerializeField]
        private UISimpleToggleGroup m_Group;

        /// <summary>
        /// Group the toggle belongs to.
        /// </summary>
        public UISimpleToggleGroup group
        {
            get { return m_Group; }
            set
            {
        ...
        [SerializeField]
        private GameObject m_SelectedRoot = null;
        [SerializeField]
        private GameObject m_ContentRoot = null;
        ...
        private void SetToggleGroup(UISimpleToggleGroup newGroup, bool setMemberValue)
        {
        ...
        {
            _SetActive(m_NormalRoot, !value);
            _SetActive(m_SelectedRoot, value);
            _SetActive(m_ContentRoot, value);
        ...
        private void _SetActive(GameObject obj, bool value)
        {
