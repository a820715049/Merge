...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class UISimpleToggleGroup : UIBehaviour
    {
        ...
        private List<UISimpleToggle> m_Toggles = new List<UISimpleToggle>();

        protected UISimpleToggleGroup()
        {}

        private void ValidateToggleIsInGroup(UISimpleToggle toggle)
        {
        ...
        public void NotifyToggleOn(UISimpleToggle toggle, bool sendCallback = true)
        {
        ...
        public void UnregisterToggle(UISimpleToggle toggle)
        {
        ...
        public void RegisterToggle(UISimpleToggle toggle)
        {
            if (!m_Toggles.Contains(toggle))
        ...
        /// </remarks>
        public IEnumerable<UISimpleToggle> ActiveToggles()
        {
