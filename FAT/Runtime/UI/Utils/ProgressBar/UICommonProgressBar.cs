/*
 * @Author: qun.chao
 * @Date: 2021-11-30 11:08:51
 */
using System;
using UnityEngine;
using UnityEngine.UI;

public class UICommonProgressBar : MonoBehaviour
{
    [SerializeField] private RectTransform fill;
    [SerializeField] private TMPro.TMP_Text tmpInd;
    [SerializeField] private Text textInd;
    ...
    private void _Refresh(float cur)
    {
        ...
        if (fill != null)
        {
            var p = Mathf.InverseLerp(mMin, mMax, _cur);
            fill.anchorMax = new Vector2(p, fill.anchorMax.y);
        }
    }
    ...
    private void _RefreshInd(long cur, long max)
    {
        ...
        if (tmpInd != null)
            ...
            textInd.text = mFormatter(cur, max);
    }
}