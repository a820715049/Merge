/*
 * @Author: tang.yan
 * @Description: 来源与产出Tips界面加宽版 
 * @Date: 2024-07-08 11:07:02
 */
...
namespace FAT
{
    public class UIItemInfoWideTips : UITipsBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            for (int i = 4; i >= 0; i--)
            {
                ...
                _FillTipsCell(path + "/OneCell/UIItemInfoWideTipsCell/Content", group.OneCell);
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    _FillTipsCell(path + "/TwoCell/UIItemInfoWideTipsCell" + j + "/Content", tempCell);
                    int tempItemIndex = j;
        ...
        protected override void OnPreOpen()
        {
            ...
            _RefreshProduce();
            //刷新tips位置
            _SetCurTipsWidth(_curItemId <= 0 ? 804 : 906);
        ...
        private void _RefreshNextLevel()
        {
            if (_curItemId <= 0)
            {
                ...
                nextLevelText.text = I18N.Text("#SysComDesc34");
            }
            else
            {
