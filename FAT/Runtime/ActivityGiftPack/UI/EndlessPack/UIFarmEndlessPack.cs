/*
 * @Author: tang.yan
 * @Description: 农场棋盘 无限礼包界面
 * @Date: 2025-05-20 11:05:37
 */
using System;
...
namespace FAT
{
    public class UIFarmEndlessPack : UIBase
    {
        ...
        private Queue<UIFarmEndlessPkgModule> _moduleList = new Queue<UIFarmEndlessPkgModule>();
        ...
        protected override void OnCreate()
        {
            ...
            for (int i = 0; i < MaxCellNum; i++)
            {
                var module = new UIFarmEndlessPkgModule();
