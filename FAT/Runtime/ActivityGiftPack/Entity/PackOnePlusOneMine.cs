/*
 * @Author: tang.yan
 * @Description: 挖矿棋盘专属 1+1礼包数据类  
 * @Date: 2025-03-26 19:03:52
 */
...
namespace FAT {
    public class PackOnePlusOneMine : GiftPack {
        public EventMineOnePlusOne confD;
        ...
        public bool CollectFreeReward(List<RewardCommitData> rewards)
        {
            ...
            BuyCount++;
            //打点
            DataTracker.oneplusone_mine_reward.Track(this, true);
            //领取完免费奖励后 关闭活动
            if (WillEnd)
            {
