 ...
 * @Date: 2025/5/13 19:13:46
 * @LastEditors: zhangpengjian
 * @LastEditTime: 2025/5/13 19:13:46
 * Description: 打怪棋盘过期奖励兑换界面
 */
...
namespace FAT
{
    public class UIActivityFightConvert : UIBase
    {
        // Image字段
        ...
        protected override void OnParse(params object[] items)
        {
            ...
            var activity = items[0] as FightBoardActivity;
            if (activity == null) 
            {
                return;
            }
