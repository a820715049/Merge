...
namespace FAT
{
    public partial class ReasonString
    {
        ...
        #region 在线奖励
        public static readonly ReasonString online_reward = new(nameof(online_reward));
        #endregion
        ...
        #region 限时合成订单
        public static readonly ReasonString limitmergeorder_reward = new(nameof(limitmergeorder_reward));
        #endregion
