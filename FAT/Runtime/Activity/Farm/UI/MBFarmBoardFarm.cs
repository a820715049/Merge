...
namespace FAT
{
    ...
    {
        // [SerializeField] private Button farmBtn;
        ...
        public void SetUp()
        {
            // farmBtn.onClick.AddListener(OnClickFarm);
        ...
        public void OnClickFarm()
        {
            ...
            if (_activity.TokenNum <= 0)
            {
                ...
                {
                    // 点击显示气泡
                    _activity.VisualTokenTip.res.ActiveR.Open(ui.mbtoken.transform.Find("TokenAdd").position, 0f, _activity);
                }
                else
                {
                    // 弹出礼包
        ...
        // 根据索引获得指定农田位置
        public Transform GetFarmByIndex(int index)
        {
