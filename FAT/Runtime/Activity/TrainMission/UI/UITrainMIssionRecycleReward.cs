// ==================================================
// // File: UITrainMIssionRecycleReward.cs
// // Author: liyueran
// // Date: 2025-08-07 11:08:44
// // Desc: $火车任务 回收奖励
// // ==================================================
...
namespace FAT
{
    public class UITrainMissionRecycleReward : UIBase
    {
        [Serializable]
        ...
        private UITrainMissionMain _mainUI;
        ...
        protected override void OnParse(params object[] items)
        {
            ...
            _curRandomBoxData = new RandomBoxMan.RandomBoxData()
            {
                RandomBoxId = 17000014,
                State = RandomBoxMan.RandomBoxState.Ready,
                Reward = new List<RewardCommitData>() { items[1] as RewardCommitData }
            };
            _mainUI = items[2] as UITrainMissionMain;
        }
        ...
        protected override void OnPreClose()
        {
            ...
            _mainUI.SetBlock(false);
        }

        protected override void OnPostClose()
        {
            _ClearBoxSpine();
            _mainUI.TrainModule.ScrollOut(MBTrainMissionTrain.TrainType.Bottom, TrainMissionUtility.LeaveActivity);
        }
        ...
        private void _CreateBoxSpine()
        {
            ...
            if (_curRandomBoxData == null)
                return;
            var spinePrefab = Game.Manager.objectMan.GetRandomBoxConfig(_curRandomBoxData.RandomBoxId)?.Spine
