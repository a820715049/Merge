 ...
 * @Date: 2025/3/26 11:24:46
 * @LastEditors: zhangpengjian
 * @LastEditTime: 2025/3/26 11:24:46
 * Description: 钓鱼棋盘过期奖励兑换界面
 */
...
namespace FAT
{
    public class UIActivityFishConvert : UIBase
    {
        // Image字段
        ...
        protected override void OnParse(params object[] items)
        {
            ...
            var activity = items[0] as ActivityFishing;
            if (activity == null) 
            {
                return;
            }
