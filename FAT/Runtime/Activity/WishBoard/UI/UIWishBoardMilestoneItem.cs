...
namespace FAT
{
    public class UIWishBoardMilestoneItem : MonoBehaviour
    {
        ...
        public void UpdateContent(UIWishBoardMilestone.Milestone node)
        {
            ...
            {
                item[i].Refresh(node.reward[i], node.isCur ? 17 : 67);
