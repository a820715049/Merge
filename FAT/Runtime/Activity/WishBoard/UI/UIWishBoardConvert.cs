...
namespace FAT
{
    public class UIWishBoardConvert : UIBase
    {
        public UIImageRes bg;
        public UIImageRes titleBg;
        public TextMeshProUGUI title;
        public TextMeshProUGUI desc;
        public UIImageRes frame;
        ...
        protected override void OnParse(params object[] items)
        {
            ...
            var activity = items[0] as WishBoardActivity;
            if (activity == null)
            {
                return;
            }
            ...
            var visual = activity.VisualConvertPopup;
            ...
            visual.visual.Refresh(frame, "frame");
        }
