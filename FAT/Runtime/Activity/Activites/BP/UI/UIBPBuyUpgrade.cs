...
namespace FAT
{
    public class UIBPBuyUpgrade : UIBase
    {
        ...
        private void AddButton()
        {
            ...
            transform.AddButton("Content/bg/Rewards/luxury/claimBtn", OnClickPurchaseBtn).WithClickScale().FixPivot();
        }
        ...
        protected override void OnPostOpen()
        {
            ...
            {
                // 里程碑跳转
                main.FancyScroll.JumpToWithSort(_activity.GetCurMilestoneLevel() + 1);
            }
        }
        ...
        private void RefreshTheme()
        {
            ...
            var visual = _activity.VisualUpgrade;
