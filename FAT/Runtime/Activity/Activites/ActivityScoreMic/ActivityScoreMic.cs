...
namespace FAT
{
    public class ActivityScoreMic : ActivityLike, IBoardEntry
    {
        ...
        public VisualPopup MainPopup { get; } = new(UIConfig.UIBPMain); // 主界面 todo 替换成正确界面名字
        public VisualPopup SettlePopup { get; } = new(UIConfig.UIPachinkoConvert); //活动结算界面  todo 替换成正确界面名字
