...
namespace FAT {
    public class PackOnePlusOneMineCart : GiftPack {
        public EventCartOnePlusOne confD;
        ...
        public PackOnePlusOneMineCart(ActivityLite lite_) {
            Lite = lite_;
            confD = GetEventCartOnePlusOne(lite_.Param);
        ...
        public bool CollectFreeReward(List<RewardCommitData> rewards)
        {
            ...
            BuyCount++;
            //打点
            DataTracker.oneplusone_minecart_reward.Track(this, true);
            //领取完免费奖励后 关闭活动
            if (WillEnd)
            {
