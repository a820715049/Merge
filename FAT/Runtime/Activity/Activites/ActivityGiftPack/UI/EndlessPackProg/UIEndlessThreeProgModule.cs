/*
 * @Author: tang.yan
 * @Description: 三格无限礼包版界面奖励格子module
 * @Date: 2025-02-14 11:02:31
 */
using System;
...
namespace FAT
{
    public class UIEndlessThreeProgModule
    {
        //根节点
        ...
        //当前要显示的数据Data
        private PackEndlessThree.EndlessThreePkgData _curRewardData;
        //是否是末尾三个module
        ...
        public void OnModuleCreate()
        {
            ...
            _moduleRoot.FindEx("Token", out tokenGo);
            tokenIcon = _moduleRoot.FindEx<UIImageRes>("Token/icon");
            tokenNum = _moduleRoot.FindEx<TMP_Text>("Token/count");
        }
        
        public void OnModulePreOpen(PackEndlessThree _pack)
        {
            pack = _pack;
        }
