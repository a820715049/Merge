 ...
 * @Date: 2025/5/16 17:56:01
 * @LastEditors: zhangpengjian
 * @LastEditTime: 2025/5/16 17:56:01
 * Description: 战斗棋盘 1+1礼包界面 
 */
...
namespace FAT
{
    public class UIOnePlusOneFightPack : UIBase
    {
        [Serializable]
        ...
        private PackOnePlusOneFight pack;
        ...
        {
            pack = (PackOnePlusOneFight)items[0];
        }
        ...
        private void _PurchaseComplete(IList<RewardCommitData> list_) {
            ...
            //打点
            //DataTracker.oneplusone_fight_reward.Track(pack, false);
        }
