/*
 * @Author: tang.yan
 * @Description: 三格无限礼包界面
 * @Date: 2024-07-01 14:07:18
 */
using System;
...
namespace FAT
{
    public class UIEndlessThreePack : UIBase
    {
        private Queue<UIEndlessThreePkgModule> _moduleList = new Queue<UIEndlessThreePkgModule>();
        private TMP_Text _remainTimeText;       //剩余时间文本
        private TMP_Text _titleText1;           //标题文本1
        ...
        protected override void OnCreate()
        {
            ...
            transform.AddButton("Content/Panel/BtnClose", base.Close).FixPivot();
            //固定点位
            ...
            //各个module
            string rewardPath = "Content/Panel/Reward/RewardList/UIEndlessThreeReward";
            for (int i = 0; i < MaxCellNum; i++)
            {
                var module = new UIEndlessThreePkgModule();
            ...
            _titleText1 = transform.FindEx<TMP_Text>("Content/Panel/Bg/Title1");
