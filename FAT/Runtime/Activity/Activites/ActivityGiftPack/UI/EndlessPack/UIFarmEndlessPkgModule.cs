/*
 * @Author: tang.yan
 * @Description: 无限礼包界面奖励格子module 
 * @Date: 2024-01-03 14:01:03
 */
...
namespace FAT
{
    public class UIFarmEndlessPkgModule
    {
        //根节点
        ...
        //活动数据
        private PackEndlessFarm pack;
        //当前要显示的数据Data
        private PackEndlessFarm.EndlessPkgData _curRewardData;
        ...
        public void OnModulePreOpen(PackEndlessFarm _pack)
        {
            pack = _pack;
        }
        ...
        private void _RefreshLabel()
        {
            ...
            else if (isValid)
            {
                ...
                var pkgConf = GetOneEventFarmEndlessInfoByFilter(x => x.Id == _curRewardData.BelongPkgId);
                iapLabel.Clear();
