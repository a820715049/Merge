...
namespace FAT
{
    public class UIEndlessPack : UIBase
    {
        ...
        private Queue<UIEndlessPkgModule> _moduleList = new Queue<UIEndlessPkgModule>();
        ...
        protected override void OnCreate()
        {
            ...
            for (int i = 0; i < MaxCellNum; i++)
            {
                var module = new UIEndlessPkgModule();
