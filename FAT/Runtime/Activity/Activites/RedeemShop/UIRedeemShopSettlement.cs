...
namespace  FAT
{
    public class UIRedeemShopSettlement : UIBase
    {
        ...
        public ActivityRedeemShopLike Activity;

        internal MBRewardLayout.CommitList result;
        public ActivityVisual Visual => Activity.VisualUIRedeemShopSettlement.visual;
        ...
        {
            Activity = items[0] as ActivityRedeemShopLike;
        ...
        public virtual void RefreshTheme()
        {
           ...
           //title.SetText(I18N.Text(Activity.EventRedeemConfig.Name));
        }
        ...
        public void Refresh()
        {
            ...
            if (anyConvert)
            {
                ...
                //desc.fontSizeMax = 50;
                desc.SetTextFormat(I18N.Text("#SysComDesc1160"),
                    ZString.Format("<sprite name=\"{0}\">",
                        Game.Manager.objectMan.GetTokenConfig(Activity.EventRedeemConfig.TokenId).SpriteName));
