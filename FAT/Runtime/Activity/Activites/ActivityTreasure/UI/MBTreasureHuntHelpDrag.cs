...
public class MBTreasureHuntHelpDrag : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    void IEndDragHandler.OnEndDrag(PointerEventData evt)
    {
        ...
        if (transform.childCount == mTotalNum && mTotalNum > 1)
        {
            ...
            MessageCenter.Get<FAT.MSG.TREASURE_HELP_DRAG_END>().Dispatch(tarIdx);
