...
namespace FAT
{
    ...
    public class DecorateActivity : ActivityLike, IRankingSource
    {
        ...
        public override void LoadSetup(ActivityInstance data_)
        {
            ...
            _curLevel = ReadInt(2, data_.AnyState);
        ...
        public List<RewardCommitData> ClaimLevelReward()
        {
            ...
            var level = Game.Manager.configMan.GetEventDecorateLevelConfig(CurGroupConf.IncludeLvId[_curLevel]);
